...
//		1. 사용자 입력값
		...
		String[] foods = request.getParameterValues("food"); //복수개 데이터 처리 (체크박스)\
...
//		html선언
		...
		PrintWriter out = response.getWriter(); //대상을 http 응답 message로 하는 문자기반 출력 스트림
		...
		out.println("</head>");
		out.println("<body>");
		out.println("<h1>개인취향검사 결과 - GET</h1>");
